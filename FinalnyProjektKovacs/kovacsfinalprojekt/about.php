		...
		<div class="section-margin-top about-section">
			<div class="row">				
				<div class="tm-section-header">
					...
					<div class="col-lg-6 col-md-6 col-sm-6"><h2 class="tm-section-title">Kto sme</h2></div>
					<div class="col-lg-3 col-md-3 col-sm-3"><hr></div>	
				</div>
			</div>
            <div class="center">
                <button onclick="location.href='zamestnanci.php'">Upraviť zamestnancov</button>
            </div>
			<div class="row">
                <?php
                foreach ($zamestnanci as $zamestnanciData => $zamestnanciHodnota) {
                ?>
				<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12">
					<div class="tm-about-box-1">
						<a href="#"><?php
                            echo '<img style="border-radius: 50%" src="img/'.$zamestnanciHodnota['obrazok'].'" onerror="this.src=\'img/altimage.jpg\'" width="130" height="130" >';
                            ?></a>
						<h3 class="tm-about-box-1-title"><?php echo $zamestnanciHodnota['meno']; ?></h3>
						<p class="margin-bottom-15 gray-text"><?php echo $zamestnanciHodnota['popis']; ?></p>
						<div class="gray-text">
							<a href="#" class="tm-social-icon"><i class="fa fa-twitter"></i></a>
							<a href="#" class="tm-social-icon"><i class="fa fa-facebook"></i></a>
							<a href="#" class="tm-social-icon"><i class="fa fa-pinterest"></i></a>
