  ...
  <body class="tm-gray-bg">
	  				...
	  				<nav class="tm-nav">
						<ul>
                            ...
                            foreach ($menu as $item) {
                                echo '<li><a href="'.$item['url'].'">'.$item['nazov'].'</a></li>';
                            }
                            ?>
						</ul>
					</nav>		
	...
	<section class="container tm-home-section-1" id="more">
		...
		<div class="section-margin-top">
            ...
            <div class="center">
                <button onclick="location.href='admin.php'">Upraviť dovolenky</button>
            </div>
                <?php
                foreach ($dovolenky as $dovolenkyNazov => $dovolenkyHodnota) {
                ?>
				<div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
					<div class="tm-tours-box-1">
                        <?php
                        echo '<img class="box" src="img/'.$dovolenkyHodnota['obrazok'].'" onerror="this.src=\'img/altimage.jpg\'" >';
                        ?>
						<div class="tm-tours-box-1-info">
							<div class="tm-tours-box-1-info-left">
								<p class="text-uppercase margin-bottom-20"><?php echo $dovolenkyNazov; ?></p>
								<p class="gray-text"><?php echo $dovolenkyHodnota['datum'] ?></p>
							</div>
							<div class="tm-tours-box-1-info-right">
								<p class="gray-text tours-1-description"><?php echo $dovolenkyHodnota['popis'] ?></p>
							</div>							
						</div>
						<div class="tm-tours-box-1-link">
							<div class="tm-tours-box-1-link-left">
								<?php
                                foreach ($dovolenkyHodnota['atributy'] as $atribut) {
                                    if($atribut['atribut_nazov'] === 'dlzka') {
                                        echo '<p> Dĺžka: '.$atribut['atribut_hodnota'];
                                    }
                                }
                                ?>
							</div>
							<a href="#" class="tm-tours-box-1-link-right">
                                <?php
                                foreach ($dovolenkyHodnota['atributy'] as $atribut) {
                                    if($atribut['atribut_nazov'] === 'cena') {
                                        echo $atribut['atribut_hodnota'];
                                    }
                                }
                                ?>
							</a>							
